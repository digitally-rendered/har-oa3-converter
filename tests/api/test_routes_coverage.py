...
from har_oa3_converter.api.routes import router, get_conversion_options, convert_document
...
class TestApiRoutesExtra:
    ...
    def test_convert_document_json_content_response(self, mock_convert_file, client, sample_har_file):
    ...
    @mock.patch('har_oa3_converter.api.routes.convert_file')
    def test_convert_document_yaml_content_response(self, mock_convert_file, client, sample_har_file):
        ...
        sample_openapi = {"openapi": "3.0.0", "info": {"title": "API", "version": "1.0.0"}, "paths": {}}
    ...
    @mock.patch('har_oa3_converter.api.routes.convert_file')
    def test_convert_document_with_accept_param(self, mock_convert_file, client, sample_har_file):
        ...
        with open(sample_har_file, "rb") as f:
            response = client.post(
                ...
                files={"file": ("test.har", f, "application/json")},
                headers={"Accept": "application/yaml"}  # This will be overridden by the query param
            )
    ...
    @mock.patch('har_oa3_converter.api.routes.convert_file')
    def test_convert_document_with_yaml_file_json_output(self, mock_convert_file, client):
