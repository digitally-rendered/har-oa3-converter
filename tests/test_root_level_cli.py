"""Tests for the root-level CLI module."""
...
# Direct import using the exact path
...
class TestRootLevelCli:
    """Test class for the root-level CLI module."""
    
    def test_parse_args_minimal(self):
        """Test parsing arguments with minimal options."""
        args = har_oa3_converter.cli.parse_args(["input.har"])
    ...
    def test_parse_args_with_output(self):
        ...
        args = har_oa3_converter.cli.parse_args(["input.har", "-o", "custom.yaml"])
    ...
    def test_parse_args_with_json(self):
        ...
        args = har_oa3_converter.cli.parse_args(["input.har", "--json"])
    ...
    def test_parse_args_with_metadata(self):
        ...
        args = har_oa3_converter.cli.parse_args([
            "input.har",
            "--title", "Custom API",
            "--version", "2.0.0",
    ...
    def test_parse_args_with_servers(self):
        ...
        assert args.input == "input.har"
        assert args.servers == ["https://api.example.com", "https://staging.example.com"]
    ...
    def test_main_with_yaml_output(self, sample_har_file):
        ...
        try:
            ...
            exit_code = har_oa3_converter.cli.main([sample_har_file, "-o", output_file.name])
    ...
    def test_main_with_json_output(self, sample_har_file):
        ...
        try:
            ...
            exit_code = har_oa3_converter.cli.main([sample_har_file, "-o", output_file.name, "--json"])
    ...
    def test_main_with_custom_options(self, sample_har_file):
        ...
        try:
            ...
            exit_code = har_oa3_converter.cli.main([
                sample_har_file, 
                "-o", output_file.name,
                "--title", "Custom API",
                "--version", "2.0.0",
    ...
    def test_main_error_invalid_input(self):
        ...
        try:
            ...
            exit_code = har_oa3_converter.cli.main([invalid_file])
    ...
    def test_main_error_nonexistent_input(self):
        ...
        exit_code = har_oa3_converter.cli.main(["nonexistent.har"])
        
        # Should return non-zero exit code for error
        assert exit_code != 0
        
    def test_main_module_execution(self, monkeypatch):
        """Test the module's __main__ execution path using monkeypatch."""
        # Mock sys.exit and sys.argv to simulate main module execution
        exit_values = []
        ...
        # Simulate calling main through __name__ == "__main__" code path
        # We just run the function directly since we can't easily execute the if block
        result = har_oa3_converter.cli.main()
        sys.exit(result)
        
        # Verify the exit code was non-zero (since file doesn't exist)
