...
class TestFormatConverter:
    ...
    def test_guess_format_from_file(self, sample_openapi3_file, sample_har_file):
        ...
        assert guess_format_from_file("nonexistent.yaml") in ["openapi3", "swagger"]  # Still guesses by extension
    ...
    def test_openapi3_to_swagger_private_methods(self, sample_openapi3_file):
        ...
        assert converted_schema["properties"]["ref_prop"]["$ref"] == "#/definitions/OtherSchema"
        assert converted_schema["properties"]["array_prop"]["items"]["$ref"] == "#/definitions/ItemSchema"
    ...
    def test_error_handling(self, sample_har_file, broken_json_file):
        ...
        with pytest.raises(ValueError):
            convert_file(sample_har_file, "output.txt", "har", "definitely_not_a_real_format")
