...
class TestFormatConverterSchemaCoverage:
    ...
    def test_openapi3_to_swagger_complex_schema(self, sample_openapi3):
        ...
        sample_openapi3["components"]["schemas"]["ComplexType"] = {
            "type": "object",
            "properties": {
                "oneOf_array": {"oneOf": [{"type": "string"}, {"type": "integer"}]},
                "anyOf_array": {
                    "anyOf": [
                ...
                "nested_ref": {"$ref": "#/components/schemas/User"},
            },
        }
        ...
        assert complex_type["properties"]["nested_ref"]["$ref"].startswith(
            "#/definitions/"
        )
    ...
    def test_postman_to_har_converter_with_empty_response(self, sample_postman):
        ...
        try:
            ...
            with open(tmp_out_path, "r") as f:
                ...
                assert (
                    len(har_content["log"]["entries"]) >= 3
                )  # At least 3 entries from our test data
        finally:
            # Clean up temp files
    ...
    def test_convert_file_with_no_source_format(self, sample_openapi3):
        ...
        try:
            ...
            result = convert_file(tmp_in_path, tmp_out_path, target_format="swagger")
    ...
    def test_openapi3_to_openapi3_converter_with_options(self, sample_openapi3):
        ...
        try:
            ...
            with open(tmp_out_path, "r") as f:
                ...
                assert ":" in content
                assert (
                    "openapi: '3.0.0'" in content.replace('"', "'")
                    or "openapi: 3.0.0" in content
                )
        finally:
            # Clean up temp files
            if os.path.exists(tmp_in_path):
