...
class TestHarToOas3Converter:
    ...
    def test_extract_paths_with_relative_url(self):
        ...
        har_with_relative_url = {
            "log": {
                "entries": [
                    {
                        "request": {"method": "GET", "url": "users?id=123"},
                        "response": {},
                    }
                ]
            }
    ...
    def test_extract_request_body(self):
        ...
        invalid_json_request = {
            "postData": {"mimeType": "application/json", "text": "invalid json"}
        }
    ...
    def test_extract_responses(self):
        ...
        text_response = {
            ...
            "content": {"mimeType": "text/plain", "text": "Success"},
        }
        ...
        invalid_json_response = {
            ...
            "headers": [{"name": "Content-Type", "value": "application/json"}],
            "content": {"mimeType": "application/json", "text": "invalid json"},
        }
        ...
        no_content_response = {"status": 204, "statusText": "No Content", "headers": []}
    ...
    def test_infer_schema(self):
        ...
        assert (
            converter.components["schemas"][schema_name]["properties"]["id"]["type"]
            == "integer"
        )
    ...
    def test_convert_with_options(self, sample_har_file):
        ...
        spec = converter.convert(
            sample_har_file, validate_schema=False, additional_option="value"
        )
