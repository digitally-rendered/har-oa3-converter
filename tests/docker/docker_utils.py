...
ADJECTIVES = [
    "swift", "bright", "calm", "eager", "fair", "gentle", "happy", "jolly", "kind",
    "lively", "mighty", "noble", "proud", "quiet", "rapid", "sunny", "witty", "zealous",
    "brave", "clever", "daring", "elegant", "fierce", "vivid", "wise", "bold", "crisp"
]

NOUNS = [
    "apple", "breeze", "cloud", "dream", "eagle", "flower", "garden", "harbor", "iris",
    "journey", "kite", "lake", "meadow", "nest", "ocean", "path", "quilt", "river", "star",
    "tree", "valley", "wave", "zenith", "dawn", "forest", "mountain", "sunset", "thunder"
]
