...
class TestRootCli:
    ...
    def test_main_with_module_execution(self):
        ...
        try:
            ...
            sys.argv = ["cli.py", "nonexistent.har"]  # Will fail because file doesn't exist
            
            # Call the __main__ block code
            if hasattr(har_oa3_converter.cli, "__name__") and har_oa3_converter.cli.__name__ == "__main__":
