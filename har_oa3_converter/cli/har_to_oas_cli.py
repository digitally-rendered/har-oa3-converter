...
def parse_args(args: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--json", help="Output in JSON format instead of YAML", action="store_true"
    )

    parser.add_argument("--title", help="API title", default="API generated from HAR")

    parser.add_argument("--version", help="API version", default="1.0.0")
...
def main(args: Optional[List[str]] = None) -> int:
    ...
    try:
        ...
        spec = converter.convert(input_path, validate_schema=validate_schema)
