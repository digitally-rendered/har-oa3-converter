...
class HarToOas3Converter:
    ...
    def _extract_parameters(self, request: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        for header in headers:
            ...
            # Skip common headers
            if name.lower() in {"host", "user-agent", "accept", "content-length", 
    ...
    def _extract_responses(self, response: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            status: {
                "description": response.get("statusText", "Response")
            }
        }
    ...
    def _infer_schema(self, prefix: str, data: Any, used_names: Optional[Set[str]] = None) -> str:
    ...
    def convert(self, har_path: str, output_path: Optional[str] = None, validate_schema: bool = True, **options) -> Dict[str, Any]:
